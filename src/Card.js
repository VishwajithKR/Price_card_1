  ...
  return <div class="col-lg-4 m-5">
    <div class="card mb-5 mb-lg-0">
      <div class="card-body">
        ...
        <ul class="fa-ul">
          {
            props.data.futures.map(obj => {
              if (obj.enable) {
                return <li><span class="fa-li"><i class="fas fa-check"></i></span>{obj.mention ? <strong>{obj.name}</strong> : obj.name}</li>
              } else {
